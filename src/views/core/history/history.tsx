            ...
            <TimelineContent>
              ...
              <Box sx={{ mt: 2, display: 'flex', alignItems: 'center' }}>
                <img
                  ...
                  height={28}
                  alt='invoice.pdf'
                  src='https://demos.themeselection.com/materio-mui-react-nextjs-admin-template/demo-1/images/icons/file-icons/pdf.png'
                />
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              ...
              <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                <Box sx={{ display: 'flex' }}>
                  <Avatar
                    src='https://demos.themeselection.com/materio-mui-react-nextjs-admin-template/demo-1/images/avatars/2.png'
            ...
            <TimelineContent>
              <Box sx={{ mb: 3, display: 'flex', flexDirection: { sm: 'row', xs: 'column' } }}>
                <ImgShoe
                  ...
                  height='85'
                  alt='Shoe img'
                  src='https://demos.themeselection.com/materio-mui-react-nextjs-admin-template/demo-1/images/misc/shoe.jpeg'
                />
                <Box sx={{ ml: { sm: 3, xs: 0 } }}>
                  <Box
                    sx={{
          ...
          <TimelineItem>
            ...
            <TimelineContent>
              ...
              <Box sx={{ display: 'flex', alignItems: 'center' }}>
                <Avatar
                  src='/materio-mui-react-nextjs-admin-template/demo-1/images/avatars/1.png'
                  sx={{ width: '2rem', height: '2rem', mr: 2 }}
                />
                <Typography variant='subtitle2' sx={{ fontWeight: 600 }}>
                  John Doe (Client)
